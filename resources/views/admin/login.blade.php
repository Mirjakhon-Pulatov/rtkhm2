                    ...
                    <div class="bg-primary bg-soft">
                        <div class="row">
                            ...
                            <div class="col-5 align-self-end">
                                <img src="{{ asset('public/assets/admin/images/profile-img.png') }}"
                                     alt="Logo Bizzone" class="img-fluid">
                            </div>
                        </div>
                    </div>
                            ...
                            <a href="/" class="auth-logo-dark">
                                <div class="avatar-md profile-user-wid mb-4">
                                        <span class="avatar-title rounded-circle bg-light"
                                            ...
                                            <img src="{{ asset('public/assets/admin/images/favicon.ico') }}"
                                                 alt="Logo Cms" height="54">
                                        </span>
                                </div>
                            </a>
                        </div>
                        <div class="p-2">
                            <form class="form-horizontal" action="{{ route('login.ajax') }}" method="POST"
                                ...
                                <div class="mt-3 d-grid">
                                    <button class="btn btn-primary waves-effect waves-light" type="submit">Войти
                                    </button>
                                </div>

                                <div class="mt-4 text-center">
                                    <a href="https://t.me/erkinov_8360" target="_blank" class="text-muted"><i
                ...
                <div class="mt-5 text-center">
                    ...
                    <div>
                        <p class="text-white">©
                            ...
                            <a class="text-white text-decoration-underline" href="https://bizzone.uz"
                               target="_blank">Bizzone.uz</a>
                        </p>
                    </div>
                </div>
    ...
    $(document).ready(function () {
        $("#ajax-login-form").submit(function (e) {
            ...
            $.ajax({
                ...
                error: function (e) {
                    if ($("#username").val(""), $("#password").val(""), e.responseJSON
                        .error) {
                        ...
                        Command: toastr.error("Пожалуйста попробуйте еще !",
                            "Неверные данные !")
                    }
                }
            })
